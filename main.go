...
var (
	CH1, CH2, CH3, CH4, CH5, CH6, CH7, CH8, CH9, CH10, CH11, CH12, CH13, CH14, CH15, CH16 uint16
...
func main() {
	...
	for {
		...
		// this might be important for later when we do something based on the connection state
